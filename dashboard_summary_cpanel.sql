-- phpMyAdmin SQL Dump for Dashboard Summary Stored Procedure
-- Compatible with MariaDB 10.6 and MySQL 5.7+
-- This file can be imported directly in cPanel/phpMyAdmin
-- It will create the stored procedure: sp_dashboard_summary(IN p_user_id INT, IN p_date DATE)

-- Optional: select your database first (uncomment and edit)
-- USE `your_database_name`;

DROP PROCEDURE IF EXISTS sp_dashboard_summary;
DELIMITER $$
CREATE PROCEDURE sp_dashboard_summary(IN p_user_id INT, IN p_date DATE)
BEGIN
  DECLARE v_date DATE;
