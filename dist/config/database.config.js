...
const getDatabaseConfig = (configService) => {
    ...
    const baseConfig = {
        ...
        entities: [
            ...
            feedback_report_entity_1.FeedbackReport, product_report_entity_1.ProductReport, visibility_report_entity_1.VisibilityReport, competitor_report_entity_1.CompetitorReport, sales_client_payment_entity_1.SalesClientPayment, product_return_entity_1.ProductReturn,
        ],
        synchronize: false,
